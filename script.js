const locoScrolling = () => {
  ...
  // after everything is set up, refresh() ScrollTrigger and then update LocomotiveScroll because padding may have been added for pinning, etc.
...
const profileEffects = () => {
  // Animation pour la section profil
...
// Fonctionnalité de clic sur les cartes de projets
const projectCardClicks = () => {
